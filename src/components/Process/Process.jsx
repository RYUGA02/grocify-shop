...
const Process = () => {
  const renderSteps = steps.map((item) => {
    return (
      ...
      >
        <span className="flex justify-center items-center mx-auto rounded-full text-white w-18 h-18 text-8xl bg-zinc-800 outline-[3px] outline-offset-7 outline-zinc-800 outline-dashed">
          {item.number}
        </span>
  ...
  return (
    <section>
      <div className="max-w-[1400px] mx-auto px-10">
        <div className="w-fit mr-auto mt-30">
